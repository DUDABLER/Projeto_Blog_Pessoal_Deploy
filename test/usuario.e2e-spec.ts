...
describe('Testes dos Módulos Usuário e Auth (e2e)', () => {  // descrição do teste e2e
  ...
  it("05 - Deve atualizar um Usuário", async () => {
    return request (app.getHttpServer())
      ...
      .send({
        id: usuarioid,
        nome: "Chiguire Atualizado",
        usuario: "Chiguire@root.com",
        senha: "rootroot",
        foto: "https://i.redd.it/jp9ib4p58ke61.jpg",
      })
      .expect(200)
      .then((resposta) => {
        expect("Chiguire Atualizado").toEqual(resposta.body.nome);
      })
  })
